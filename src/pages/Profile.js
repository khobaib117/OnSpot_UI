...
const Profile = () => {
  ...
  await axios.post("http://localhost:2000/retrive",data)
  .then(res=>{
...
await axios.put('http://localhost:2000/update',data)
.then(res=>{
  ...
  return (
    ...
    {localStorage.getItem("email")?
       ...
       <Avatar  src="img/tech/bg2.jpeg"    sx={{ height: '170px', width: '170px' ,margin:"0px auto" }}/>
         ...
         <Row sm="12">
           ...
           <TextField id="outlined-basic" color="secondary" 
            focused value={lastName}  fullWidth label="Last Name" 
            variant="filled" 
         ...
         <Row sm="12">
           ...
           <TextField id="outlined-basic"  type="password"        
            color="secondary"  focused  value={Password}  
            fullWidth label="Password" variant="filled"
             style={{backgroundColor:"white"}}>
               <RemoveRedEyeIcon/>
               </TextField>
           </Col>
         ...
         <br></br>
             ...
             <Button variant="contained" component="span" size='large' onClick={handleOpen} style={{background:"#154360"}}>
               Update Profile
             </Button>
     ...
     <Dialog maxWidth={"xs"} fullWidth
                     ...
                     >
                     <DialogTitle className="dialogHeading" style={{backgroundColor:"#154360",color:"white",textAlign:"center"}} id="alert-dialog-title">Update Profile</DialogTitle>
         ...
         <Row sm="12">
           ...
           <TextField id="outlined-basic"        
            ...
            helperText={PasswordError === true ? "Field Rqruired" : ''}
            fullWidth label="Password" variant="filled"
             style={{backgroundColor:"white"}}/>
           </Col>
           <Col xs="2">
                     ...
                     <DialogActions style={{backgroundColor:""}}>
                      <Grid container justify="center" style={{textAlign:"center"}}>
                         ...
                         <Grid item xs={6}>
                             <Button  type="submit" onClick={handleClickOpen}  style={{ color:"#154360"}}>
                                 Update
                             </Button>
         ...
         </div>:<Redirect from='/profile' to="login"/>
    }
    </>
